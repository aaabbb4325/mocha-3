  ...
  return (
    <div class="flex flex-col gap-4 p-8">
      ...
      <div class="collapse collapse-arrow bg-base-200">
        ...
        <div class="collapse-content">
          <p>ProudParrot2 - OG Mocha, Bog/Truffled - Games, Bread/Genizy - Games, myntblue - a few games, maintenance and Bug Fixes, ELJahames - Maintenance and paid for the domain </p>
        </div>
      </div>
    </div>
  )
